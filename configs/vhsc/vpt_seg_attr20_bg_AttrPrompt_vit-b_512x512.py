_base_ = [
    '../_base_/models/attrPromptclip.py', '../_base_/datasets/vhsc_attr20_bg_512x512.py',
...
model = dict(
    ...
    backbone=dict(
        type='VPTCLIPAttrPromptVisionTransformer',
        patch_size=16,
        width=768,
        output_dim=512,
        get_embeddings=True,
        ...
        prompt_dim=768,
        total_d_layer=11,
        TEPath = 'configs/_base_/datasets/text_embedding/text_embedding.npy',
        style='pytorch'),
    decode_head=dict(
        type='ATMSingleHeadSegAttr',
        img_size=img_size,
        ...
        loss_decode=dict(
            type='SegLossOurs', num_classes=num_classes, dec_layers=3,
            mask_weight=1.0, #20.0
            dice_weight=1.0,
            loss_weight=1.0),
    ),
