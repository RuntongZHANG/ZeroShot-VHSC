...
def parse_args():
    ...
    parser.add_argument('-config', default='configs/vhsc/vpt_seg_attr20_bg_AttrPrompt_vit-b_512x512.py', type=str, help='train config file path')
    parser.add_argument('--work-dir', default='work_dirs/vpt_seg_attr20_bg_AttrPrompt_vit-b_512x512', help='the dir to save logs and models')
    parser.add_argument(
