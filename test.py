...
def parse_args():
    ...
    parser.add_argument('-config', default='configs/vhsc/vpt_seg_attr20_bg_AttrPrompt_vit-b_512x512.py',
                        type=str, help='test config file path')
    parser.add_argument('-checkpoint', default='checkpoints/AttrPromptCheckpoint.pth',
                        type=str, help='checkpoint file')
    parser.add_argument('-work-dir', default='work_dirs/vpt_seg_attr20_bg_AttrPrompt_vit-b_512x512',
                        type=str, help=(
            'if specified, the evaluation metric results will be dumped' 'into the directory as json'))
    parser.add_argument(
...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            # dataset.evaluate_attributes(seen_idx, unseen_idx, results, **eval_kwargs)  ##modify this part (Custom Evaluation)
            dataset.evaluate_classes(seen_idx, unseen_idx, results, **eval_kwargs)  ##modify this part (Custom Evaluation)
